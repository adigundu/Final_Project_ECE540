...
HD_PWD='N:/ECE540/540FinalProject/ece_540_project_4_v1.runs/world_map_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log world_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source world_map.tcl
