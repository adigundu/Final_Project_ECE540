...
synth_design -top map4 -part xc7a100tcsg324-1 -fanout_limit 1000 -directive FewerCarryChains -retiming -mode out_of_context

rename_ref -prefix_all map4_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef map4.dcp
