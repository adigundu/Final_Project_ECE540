...
HD_PWD='C:/Final_Project_ECE540-bots_on_new_map_integration/ece_540_project_4_v1.runs/map1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log map1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source map1.tcl
